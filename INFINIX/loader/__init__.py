        ...
        for client in infclts:
            with open(name) as f:
                ...
                if glk: 
                    ...
                    modules["userbot"] = INFINIX; modules["userbot.utils"] = _utilz; spec.loader.exec_module(_infx); client.infx_cmd[blik] = _infx; modules["infinix"+_infx] = _infx; logpl.info("🔥Imported "+ blik)
                else: 
